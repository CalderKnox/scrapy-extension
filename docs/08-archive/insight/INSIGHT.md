...
> **Maintainer history, not a public roadmap.** This file is a dated execution-era deep-dive. For current public behavior see [`../../README.md`](../../../README.md); for API/maturity guarantees see [`../../STABILITY.md`](../../../.github/STABILITY.md); for operations see [`../runbook.md`](../../05-runbooks/runbook.md). Treat the findings below as historical context unless a current issue/PR explicitly revives an item.
